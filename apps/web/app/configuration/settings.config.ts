export default {
  ...
  ogTitle: process.env.NUXT_PUBLIC_OG_TITLE || process.env.OG_TITLE || 'Ovatics \u2013 Vielfalt. Qualit\u00e4t. Vertrauen.',
  ...
  metaTitle: process.env.NUXT_PUBLIC_META_TITLE || process.env.METATITLE || 'Ovatics \u2013 Vielfalt. Qualit\u00e4t. Vertrauen.',
  metaDescription: process.env.NUXT_PUBLIC_META_DESCRIPTION || process.env.METADESC || 'Ovatics Online-Shop f\u00fcr ausgew\u00e4hlte Produkte',
  metaKeywords: process.env.NUXT_PUBLIC_META_KEYWORDS || process.env.METAKEYWORDS || 'Ovatics, Online-Shop, Babynahrung, Champagner, Pflege, Spirits',
  ...
  robotsUrlWithParameters: process.env.NUXT_PUBLIC_ROBOTS_URL_WITH_PARAMETERS === 'true',
  ...
  enableGoogleAnalytics: process.env.NUXT_PUBLIC_ENABLE_GOOGLE_ANALITICS === 'true',
  googleAnalyticsTrackingId: process.env.NUXT_PUBLIC_GOOGLE_ANALITICS_TRACKING_ID || '',
  sendGrossPricesToGoogleAnalytics: process.env.NUXT_PUBLIC_SEND_GROSS_PRICES_TO_GOOGLE_ANALITICS === 'true',
  googleAnalyticsCookieGroup: process.env.NUXT_PUBLIC_GOOGLE_ANALITICS_COOKIE_GROUP || 'CookieBar.marketing.label',
  registerCookieAsOptOut: process.env.NUXT_PUBLIC_REGISTER_COOKIE_AS_OPT_OUT === 'true',
  ...
  headerLogo:
    ...
    process.env.LOGO ||
    '/images/ovatics-header-logo.png',
  storename: process.env.NAME || 'Ovatics GmbH',
  font: process.env.NUXT_PUBLIC_FONT || 'Gilroy',
  ...
  primaryColor: process.env.NUXT_PUBLIC_PRIMARY_COLOR || '#202D89',
  ...
  secondaryColor: process.env.NUXT_PUBLIC_SECONDARY_COLOR || '#DA0813',
  headerBackgroundColor:
    process.env.NUXT_PUBLIC_HEADER_BACKGROUND_COLOR || process.env.NUXT_PUBLIC_PRIMARY_COLOR || '#202D89',
